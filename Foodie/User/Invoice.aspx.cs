...
namespace Foodie.User
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        protected void lbDownloadInvoice_Click(object sender, EventArgs e)
        {
            try
            {
                string downloadPath = @"E:\University\Kì 1 năm 5\Đồ án tốt nghiệp\Invoice\order_invoice.pdf";
                DataTable dtbl = GetOrderDetails();
                ExportToPdf(dtbl, downloadPath, "SELLING REPORT");
            ...
            {
                lblMsg.Visible = true;
                lblMsg.Text = "Thông báo lỗi:- " + ex.Message.ToString();
            }
        }
        ...
        void ExportToPdf(DataTable dtblTable, String strPdfPath, string strHeader)
        {
            ...
            prgAuthor.Add(new Chunk("Order From : Tuan Vu Restaurant", fntAuthor));
